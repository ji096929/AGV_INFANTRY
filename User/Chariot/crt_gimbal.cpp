...
void Class_Gimbal_Yaw_Motor_GM6020::TIM_PID_PeriodElapsedCallback()
{
    ...
    case (DJI_Motor_Control_Method_OMEGA):
    {
        ...
        // if (IMU->Get_WIT_Status() == WIT_Status_DISABLE)
        // {
...
void Class_Gimbal_Pitch_Motor_LK6010::TIM_PID_PeriodElapsedCallback()
{
    ...
    case (LK_Motor_Control_Method_IMU_OMEGA):
    {
        ...
        {
            PID_Omega.Set_Now(IMU->Get_Gyro_Pitch());
    ...
    case (LK_Motor_Control_Method_IMU_ANGLE):
    {
        ...
        {
            PID_Angle.Set_Now(IMU->Get_Rad_Pitch());
            PID_Angle.TIM_Adjust_PeriodElapsedCallback();
            Target_Omega = PID_Angle.Get_Out();
...
void Class_Gimbal::Init()
{
    ...
    Motor_Pitch.Init(&hcan1, DJI_Motor_ID_0x206, DJI_Motor_Control_Method_ANGLE, 3413);

    //pitch轴电机 LK6010
    Motor_Pitch_LK6010.PID_Angle.Init(16.5f, 0.0f, 0.01f, 0.0f, 6.0f * PI, 6.0f * PI);
    Motor_Pitch_LK6010.PID_Omega.Init(8000.0f, 100000.0f, 0.0003f, 0, Motor_Pitch_LK6010.Get_Output_Max(), Motor_Pitch_LK6010.Get_Output_Max());
    ...
    Motor_Pitch_LK6010.Init(&hcan1, LK_Motor_ID_0x141, DJI_Motor_Control_Method_ANGLE);
}
