...
#define YAW_MAX_TARGET_ANGLE_NORMAL	18.0f
#define YAW_MIN_TARGET_ANGLE_NORMAL	-18.0f
#define YAW_MAX_TARGET_ANGLE_PRECISION	9.0f
#define YAW_MIN_TARGET_ANGLE_PRECISION	-9.0f
#define YAW_MAX_TARGET_ANGLE_RUNNING	27.0f
#define YAW_MIN_TARGET_ANGLE_RUNNING	-27.0f

#define PITCH_MAX_TARGET_ANGLE_NORMAL	12.0f
#define PITCH_MIN_TARGET_ANGLE_NORMAL	-12.0f
#define PITCH_MAX_TARGET_ANGLE_PRECISION	6.0f
#define PITCH_MIN_TARGET_ANGLE_PRECISION	-6.0f
#define PITCH_MAX_TARGET_ANGLE_RUNNING	18.0f
#define PITCH_MIN_TARGET_ANGLE_RUNNING	-18.0f
