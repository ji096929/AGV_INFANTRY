...
void Class_Chariot::Control_Chassis()
{
    ...
    //设定速度
    tmp_chassis_velocity_x = Math_Float_To_Int(gimbal_velocity_y,-1 * Chassis.Get_Velocity_X_Max() ,Chassis.Get_Velocity_X_Max() ,-200,200);
    memcpy(CAN2_0x150_Tx_Data, &tmp_chassis_velocity_x, sizeof(int16_t));

    tmp_chassis_velocity_y = Math_Float_To_Int(gimbal_velocity_x,-1 * Chassis.Get_Velocity_Y_Max() ,Chassis.Get_Velocity_Y_Max() ,-200,200);
    memcpy(CAN2_0x150_Tx_Data + 2, &tmp_chassis_velocity_y, sizeof(int16_t));

    CAN2_0x152_Tx_Data[0] = 1;
    //		CAN2_0x152_Tx_Data[0] =0	;
    CAN2_0x152_Tx_Data[1] = 0;
    CAN2_0x152_Tx_Data[2] = 0;
